...
*/
#define ARM_V5_PAGE_TYPE_FAULT   0x00
#define ARM_V5_PAGE_TYPE_COURSE  0x01
#define ARM_V5_PAGE_TYPE_SECTION 0x02
#define ARM_V5_PAGE_TYPE_FILE    0x03
...
*/
#define ARM_V5_PAGE_NONCACHED_NONBUFFERED (0x00 << 2)
#define ARM_V5_PAGE_NONCACHED_BUFFERED    (0x01 << 2)
#define ARM_V5_PAGE_CACHED_WRITE_THROUGH  (0x02 << 2)
#define ARM_V5_PAGE_CACHED_WRITE_BACK     (0x03 << 2)
...
*/
#define ARM_V5_PAGE_DOMAIN_00 (0x00 << 5)
#define ARM_V5_PAGE_DOMAIN_01 (0x01 << 5)
#define ARM_V5_PAGE_DOMAIN_02 (0x02 << 5)
#define ARM_V5_PAGE_DOMAIN_03 (0x03 << 5)
#define ARM_V5_PAGE_DOMAIN_04 (0x04 << 5)
#define ARM_V5_PAGE_DOMAIN_05 (0x05 << 5)
#define ARM_V5_PAGE_DOMAIN_06 (0x06 << 5)
#define ARM_V5_PAGE_DOMAIN_07 (0x07 << 5)
#define ARM_V5_PAGE_DOMAIN_08 (0x08 << 5)
#define ARM_V5_PAGE_DOMAIN_09 (0x09 << 5)
#define ARM_V5_PAGE_DOMAIN_0A (0x0A << 5)
#define ARM_V5_PAGE_DOMAIN_0B (0x0B << 5)
#define ARM_V5_PAGE_DOMAIN_0C (0x0C << 5)
#define ARM_V5_PAGE_DOMAIN_0D (0x0D << 5)
#define ARM_V5_PAGE_DOMAIN_0E (0x0E << 5)
#define ARM_V5_PAGE_DOMAIN_0F (0x0F << 5)
...
/*
	...
	domain number (above)
*/
#define ARM_V5_DOMAIN_NO_ACCESS 0x00		// any access results in a domain fault
#define ARM_V5_DOMAIN_CLIENT    0x01		// check for access permissions in the page descriptor (page table)
#define ARM_V5_DOMAIN_RESERVED  0x02		// Reserved
#define ARM_V5_DOMAIN_MANAGER   0x03		// no check - a fault cannot occur

/*
	If the domain tells us to do a check (i.e. ARM_V5_DOMAIN_CLIENT) then the AP bits
...
*/
#define ARM_V5_PAGE_SECTION_USER_SPECIAL   (0x00 << 10)
#define ARM_V5_PAGE_SECTION_USER_FORBIDDEN (0x01 << 10)
#define ARM_V5_PAGE_SECTION_USER_READONLY  (0x02 << 10)
#define ARM_V5_PAGE_SECTION_USER_READWRITE (0x03 << 10)
